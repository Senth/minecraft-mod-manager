...
class LatestVersionFinder:
    @staticmethod
    def find_latest_version(versions: List[VersionInfo]) -> Union[VersionInfo, None]:
        latest_version: Union[VersionInfo, None] = None

        for version in versions:
            if not LatestVersionFinder._is_filtered(version):
    ...
    @staticmethod
    def _is_filtered_by_mod_loader(version: VersionInfo) -> bool:
